...
from transformers import BertModel, AutoConfig, BertForPreTraining
...
def main():
    ...
    # model.load_state_dict(embedding_state_dict)
    # tokenizer = AutoTokenizer.from_pretrained("/home/aiuser/SimCSE_ori/llama/llama-2-7b")
    
    # Load baseline Bert checkpoint
    model_path = '/home/aiuser/SimCSE/bert'
    ...
    def batcher(params, batch, max_length=None):
        ...
        if args.pooler == 'cls':
            ...
            # return torch.randn(pooler_output.shape[0], pooler_output.shape[1]).cpu()
